    ...
    <div>
      ...
      <div className='text-end my-3'>
        <a className={jobType === "onsite" ? "active" : ""}>
          <button type="button" onClick={() => handleJobTypeClick("onsite")} className="btn btn-info fw-bold mx-2 ">Onsite</button></a>
        <a className={jobType === "remote" ? "active" : ""}>
          <button type="button" onClick={() => handleJobTypeClick("remote")} className="btn btn-info fw-bold ">Remote</button></a>
      </div>
      <div>
